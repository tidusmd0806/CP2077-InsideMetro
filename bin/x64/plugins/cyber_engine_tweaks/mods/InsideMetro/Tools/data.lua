...
Data.Station = {
    {station = "ARASAKA_WATERFRONT", track_info = {{track = 1, is_final = true, is_invalid = false}, {track = 5, is_final = true, is_invalid = false}}},
    {station = "LITTLE_CHINA_HOSPITAL", track_info = {{track = 1, is_final = false, is_invalid = false}, {track = 5, is_final = false, is_invalid = false}}},
    {station = "LITTLE_CHINA_NORTH", track_info = {{track = 1, is_final = false, is_invalid = false}}},
    {station = "LITTLE_CHINA_SOUTH", track_info = {{track = 4, is_final = false, is_invalid = false}, {track = 5, is_final = false, is_invalid = false}}},
    ...
    {station = "LITTLE_CHINA_MEGABUILDING", track_info = {{track = 2, is_final = false, is_invalid = false}, {track = 5, is_final = false, is_invalid = false}}},
